...
import {LOGIN_USER, REGISTER_USER, AUTH_USER,LOGOUT_USER, ADD_TO_CART_USER,GET_CART_ITEMS_USER, REMOVE_CART_ITEM_USER, ONSUCCESS_BUY_USER, UPDATE_DATA_USER,CLEAR_UPDATE_USER_DATA} from './types';
                        ...
                        userCart.forEach(element => {
                                response.data.forEach((k,i)=>{
                                    if(element.id===k._id){
                                            ...
                                            response.data[i]["quantity"] = element.quantity;
                                    }else {
